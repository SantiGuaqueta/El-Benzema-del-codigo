...
def area_volumen_superficial_de_la_figura(*args)-> float:
    for volumen_area in args:
...
if __name__ == "__main__":
  ...
  print("El volumen de la figura y el area de la figura es " + str(area_volumen_superficial_de_la_figura(radio_esfera,radio_cono,altura)))
